...
const menuItems = [
    {
        link: `${pagesURLs[pages.projectsPage]}`,
        neededAuthorities: [],
        titleIntlId: `page.${pages.projectsPage}`,
    },
    {
        icon: <IconLockOpen/>,
...
function LeftNavBar() {
    ...
    const filteredItems = useMemo(
        () => menuItems.filter(item => item => item.neededAuthorities.length === 0 || accessValidate(item.neededAuthorities)),
        [accessValidate],
    );
