    ...
    return (
        <CardContent>
            <div className={classes.content}>
                <TextField
                    helperText={state.validationErrors
                            .includes(errorTypes.EMPTY_NAME)
                ...
                <TextField helperText={state.validationErrors
                        .includes(errorTypes.EMPTY_DESCRIPTION)
                    && formatMessage({id: `create.error.${errorTypes.EMPTY_DESCRIPTION}`})}
                           isError={state.validationErrors
                               .includes(errorTypes.EMPTY_DESCRIPTION)}
